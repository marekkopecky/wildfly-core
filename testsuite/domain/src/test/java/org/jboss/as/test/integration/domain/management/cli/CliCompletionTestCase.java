...
public class CliCompletionTestCase {
    ...
    public void helpTest() {
        getCandidatesLists("help", true, -1).stream().forEach(candidates ->
    ...
    public void helpWithLCharTest() {
        getCandidatesLists("help l", true, -1).stream().forEach(candidates -> {
    ...
    public void helpWithLsTest() {
        getCandidatesLists("help ls", true, -1).stream().forEach(candidates ->
                assertTrue(candidates.toString(), candidates.contains("ls"))
        );
    }
    ...
    public void helpWithDeploymentTest() {
        getCandidatesLists("help deployment ", true, -1).stream().forEach(candidates ->
