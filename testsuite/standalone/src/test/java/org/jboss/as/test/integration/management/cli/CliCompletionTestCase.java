...
public class CliCompletionTestCase {
    ...
    public void reloadWithSpaceTest() {
        getCandidatesLists("reload ", null).stream().forEach(candidates -> {
    ...
    public void reloadWithArgumentTest() {
        getCandidatesLists("reload --start-mode=", false).stream().forEach(candidates -> {
    ...
    public void operationWithObjectAsAttributeTest() {
        getCandidatesLists("/subsystem=elytron/token-realm=JwtRealm:add(jwt={}", false).stream().forEach(candidates ->
    ...
    public void complexOperationWithObjectAsAttributeTest() {
        getCandidatesLists("/subsystem=logging/logger=cdsc:add(category=cdsc,"
                + "filter={accept=true,all={},change-level=ALL,not={},"
                + "level-range={min-level=ALL,max-level=ALL,"
                + "max-inclusive=true,min-inclusive=false}", false).stream().forEach(candidates ->
            assertEquals(candidates.toString(), Arrays.asList(","), candidates)
        );
    }
    ...
    public void helpTest() {
        getCandidatesLists("help", true).stream().forEach(candidates ->
    ...
    public void helpWithLCharTest() {
        getCandidatesLists("help l", true).stream().forEach(candidates -> {
    ...
    public void helpWithLsTest() {
        getCandidatesLists("help ls", true).stream().forEach(candidates ->
            assertTrue(candidates.toString(), candidates.contains("ls"))
        );
    }
    ...
    public void helpWithDeploymentTest() {
        getCandidatesLists("help deployment ", true).stream().forEach(candidates ->
    ...
    public void subsystemTest() {
        getCandidatesLists("/subsystem", false).stream().forEach(candidates ->
    ...
    public void operationWithCharAsAttributeTest() {
        getCandidatesLists(":read-resource(p", false).stream().forEach(candidates ->
    ...
    public void connectTest() {
        getCandidatesLists("connect ", true).stream().forEach(candidates ->
