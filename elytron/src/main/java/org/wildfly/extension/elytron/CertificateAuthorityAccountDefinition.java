    ...
    private static class CertificateAuthorityAccountAddHandler extends BaseAddHandler {
        ...
        protected void performRuntime(OperationContext context, ModelNode operation, Resource resource) throws OperationFailedException {
            ...
            if (certificateAuthorityName.equalsIgnoreCase(CertificateAuthority.LETS_ENCRYPT.getName())) {
                ...
                certificateAuthority = getCertificateAuthority(context, certificateAuthorityName);
            }
        ...
        private static CertificateAuthority getCertificateAuthority(OperationContext context, String certificateAuthorityName) throws OperationFailedException {
